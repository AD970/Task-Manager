...
export default function MobileTaskList({ tasks, project_id, search, setSearch,inProgressTasks,completedTasks }: { tasks: Task[] | null, project_id: string, search: string, setSearch: React.Dispatch<React.SetStateAction<string>>, inProgressTasks: Task[] | null, completedTasks: Task[] | null }){
